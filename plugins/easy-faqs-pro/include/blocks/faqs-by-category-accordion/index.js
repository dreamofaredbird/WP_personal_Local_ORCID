( 
	 ...
	 */
	registerBlockType( 'easy-faqs/faqs-by-category-accordion', {
		/**
		 * This is the display title for your block, which can be translated with `i18n` functions.
		 * The block inserter will show this name.
		 */
		title: __( 'FAQs Accordion by Category' ),
					...
					return {
						categories: select( 'core' ).getEntityRecords( 'taxonomy', 'easy-faq-category', {
							...
							var inspector_controls = [],
								...
								accordion_style = props.attributes.accordion_style || '',
								categories_accordion_style = props.attributes.categories_accordion_style || '',
						...
						var accordion_fields = [];
						accordion_options  = [
							{
								label: __('First FAQ Visible '),
								value: 'accordion'
							},
							{
								label: __('All FAQs Start Collapsed'),
								value: 'accordion-collapsed'
							},
						];
						
						// add radio to choose accordion setting
						accordion_fields.push(
							radio_control ('Accordion Style:', accordion_style, accordion_options, 'accordion_style', function( newVal ) {
								props.setAttributes({
									accordion_style: newVal
								});
							})
						);
						...
						inspector_controls.push(							
							el (
								wp.components.PanelBody,
								{
									title: __('Accordion Display Options'),
									className: 'gp-panel-body',
									initialOpen: false,
								},
								accordion_fields
						...
						var categories_accordion_fields = [];
						categories_accordion_options  = [
							{
								label: __('First Category Open '),
								value: 'accordion'
							},
							{
								label: __('All Categories Start Collapsed'),
								value: 'accordion-collapsed'
							},
						];
						
						// add radio to choose accordion setting
						categories_accordion_fields.push(
							radio_control ('Categories Accordion Style:', categories_accordion_style, categories_accordion_options, 'accordion_style', function( newVal ) {
								props.setAttributes({
									categories_accordion_style: newVal
								});
							})
						);
						...
						inspector_controls.push(							
							el (
								wp.components.PanelBody,
								{
									title: __('Category Display Options'),
									className: 'gp-panel-body',
									initialOpen: false,
								},
								categories_accordion_fields
							)
						);
						...
						var inner_fields = [];
						inner_fields.push( el('h3', { className: 'block-heading' }, 'Easy FAQs - FAQs Accordion by Category') );
						inner_fields.push( el('blockquote', { className: 'faq-list-placeholder' }, __('A collapsable list of your FAQs, grouped by category.') ) );
