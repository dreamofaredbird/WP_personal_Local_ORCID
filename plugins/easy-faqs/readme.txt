...
= 3.2 =
* Adds the Visitor Feedback system.

= 3.0 =
* WordPress 5 compatibility
* Adds Custom Blocks for the Gutenburg editor.

= 2.0 =
* MAJOR UPGRADE: Please backup before proceeding.
* Adds QuickLinks to base plugin.
...
** 3.2.1 ** Adds the Visitor Feedback system. Let your users to tell you if an FAQ was helpful, and if not, tell you why.