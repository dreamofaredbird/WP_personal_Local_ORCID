...
function molongui_text_input( $field )
{
...
function molongui_hidden_input( $field )
{
	global $thepostid, $post;
...
function molongui_textarea_input( $field )
{
	global $thepostid, $post;
...
function molongui_checkbox( $field )
{
	global $thepostid, $post;
...
function molongui_select( $field )
{
	global $thepostid, $post;
...
function molongui_color_picker( $name, $id, $value, $desc = '' )
{
	echo '<input id="'.$id.'" type="text" class="colorpicker" name="'.$name.'" value="'.$value.'">';
}